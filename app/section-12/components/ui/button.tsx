...
const VARIANT_CLASS: Record<ButtonVariant, string> = {
  ...
  secondary:
    "h-[42px] rounded-lg border border-solid border-[#c8c8c8] bg-transparent px-4 py-3 text-[14px] font-medium tracking-[-0.28px] text-[#1d1d1d] ipad:h-[55px] ipad:rounded-[11px] ipad:px-[22px] ipad:py-0 ipad:text-[18px] ipad:tracking-[-0.36px] desktop-sm:h-10 desktop-sm:rounded-lg desktop-sm:px-4 desktop-sm:py-3 desktop-sm:text-[14px] desktop-sm:tracking-[-0.28px]",
  nav: "h-9 overflow-clip rounded-lg border border-solid border-black/20 bg-black px-5 text-[14px] font-medium tracking-[-0.28px] text-white shadow-[0px_2px_6px_0px_rgba(0,0,0,0.22)]",
};
