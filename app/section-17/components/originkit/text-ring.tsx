...
//   words: ["RING","TEXT"]
//   font: {"variant":"Bold","fontSize":"24px","textAlign":"center","fontFamily":"Inter","fontWeight":700,"lineHeight":"1em","letterSpacing":"0.02em"}
//   hoverSpeed: 8
...
export default function CircularText(props: Props) {
  ...
  useAnimationFrame((_, delta) => {
    ...
    if (
      delayUntilRef.current > 0 &&
      performance.now() < delayUntilRef.current
    ) {
      return;
    }
    delayUntilRef.current = 0;
