...
/**
 * The card artwork. Figma ships each one as a flat PNG of already-rendered
 * ASCII ("image 3083602" and friends); here the untouched render sitting in
 * public/section-29 is fed through the ascii-reveal canvas instead, so the
