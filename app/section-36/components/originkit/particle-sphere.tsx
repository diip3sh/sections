...
// Vendored unchanged apart from this header: the file drives a WebGL canvas from
// effects, so it has to be a client component, and its internal refs are typed
// `any` throughout, which strict TS will not take.
