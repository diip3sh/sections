  ...
  useEffect(() => {
    ...
    const ensureGeometry = () => {
      ...
      const settings: GeometrySettings = {
        fontFamily: currentProps.font?.fontFamily || "Inter, sans-serif",
    ...
    const renderFrame = (timestamp: number) => {
      ...
      projected.sort(
        (firstGlyph, secondGlyph) => firstGlyph.depth - secondGlyph.depth,
      );
      ...
      const fontFamily = currentProps.font?.fontFamily || "Inter, sans-serif";
  ...
  return (
    ...
    >
      <canvas
        ...
        role="img"
      >
        A rotating text sphere made from repetitions of the phrase {word}.
      </canvas>
    </div>
  );
}
