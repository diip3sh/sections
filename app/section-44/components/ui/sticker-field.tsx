...
const STICKERS = [
  ...
  },
  {
    ...
    size: CW,
    /*
      Lifted 20px on the phone only. Figma's y512.47 sets it level with the
      annotation's hand, which on a 402 frame reads as the hand resting on the
      card rather than reaching for it. A translate rather than a smaller `top`,
      so the design's own coordinate stays legible next to the correction.
    */
    className:
      "left-[56.468%] top-[512.47px] -translate-y-[20px] ipad:left-[67.07%] ipad:top-[626.27px] ipad:translate-y-0 desktop-sm:left-[77.866%] desktop-sm:top-[475.136px]",
  },
  {
    name: "drive",
    label: "Google Drive",
